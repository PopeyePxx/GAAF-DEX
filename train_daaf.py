...
<<<<<<< HEAD
shutil.copy('./models/GAAF_Dex.py', args.save_path)
shutil.copy('./train_daaf.py', args.save_path)
=======
...
<<<<<<< HEAD
            model_name_grasp = 'best_grasp_model_' + str(epoch + 1) + '_' + str(round(average_success_rate, 3)) + '.pth'
            torch.save(model.state_dict(), os.path.join(args.save_path, model_name_grasp))
=======
